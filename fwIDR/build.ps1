...
<#
.SYNOPSIS  Cross-compile IDR for all supported platforms.
.EXAMPLE
...
Write-Host "IDR - Build Script"              -ForegroundColor Cyan
Write-Host "================================" -ForegroundColor Cyan
Write-Host ""
...
function Build-Platform {
    ...
    try {
        ...
        Copy-Item "idr.yaml" "$platformDir\idr.yaml" -Force
        Write-Host "  [OK] Copied idr.yaml" -ForegroundColor Green
        return $true
